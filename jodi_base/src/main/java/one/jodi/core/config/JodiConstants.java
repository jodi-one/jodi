...
public abstract class JodiConstants {
   ...
   public static final String ALIAS_DOT_COLUMN_PREFIX =
           "([A-Za-z]{1,}[a-zA-Z_$#0-9\"]{0,})([.]{1,1})([A-Za-z]{1,}[a-zA-Z_$#0-9\"]{0,})";
   public static final String ALIAS_DOT_COLUMN_PREFIX_OR_VAR =
           "([A-Za-z#:]{1,}[a-zA-Z_$#0-9\"]{0,})([.]{1,1})([A-Za-z]{1,}[a-zA-Z_$#0-9\"]{0,})";

   public static final String XMLLOADPLANLOC = "loadPlans";
   public static final String XSDLOCPROPERTY = "xml.xsd.loadPlan";
   ...
   public static final String ERROR_FOOTER =
           "There were one or more" + " errors, to see them enable log4j logging with the -Dlog4j.info" +
   ...
   public static final String ODI12_GENERATE_SCENARIOS_FOR_MAPPINGS = "odi12.generateScenariosForMappings";
   public static final String ODI12_GENERATE_SCENARIOS_FOR_PROCEDURES = "odi12.generateScenariosForProcedures";
   public static final String ODI12_GENERATE_SCENARIOS_FOR_PACKAGES = "odi12.generateScenariosForPackages";

   public static List<String> getEmbeddedXSDFileNames() {
      return Arrays.asList(XSD_FILE_CONSTRAINTS, XSD_FILE_EXTENSIONS, XSD_FILE_LOADPLAN, XSD_FILE_PROCEDURE,
                           XSD_FILE_SEQUENCES, XSD_FILE_VARIABLES);
   }
   ...
   public String getReusableMappingPrefix(final String interfacePrefix) {
      ...
      if (interfacePrefix != null && interfacePrefix.trim()
                                                    .length() > 0) {
         result = interfacePrefix.toUpperCase()
                                 .replace(" ", "")
                                 .trim()
                                 .charAt(0) + "_";
      }
