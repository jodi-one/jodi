...
-- USER SQL
CREATE
USER "&1" IDENTIFIED BY "&2"
DEFAULT TABLESPACE "&3"
TEMPORARY TABLESPACE "&4";

-- QUOTAS
ALTER
USER "&1" QUOTA UNLIMITED ON "&3";
...
GRANT
CREATE
ATTRIBUTE DIMENSION TO "&1" ;
GRANT CREATE
ROLLBACK SEGMENT TO "&1" ;
GRANT CREATE
SYNONYM TO "&1" ;
GRANT
CREATE SEQUENCE TO "&1";
GRANT
CREATE
HIERARCHY TO "&1" ;
GRANT CREATE
CUBE BUILD PROCESS TO "&1" ;
GRANT CREATE
PROFILE TO "&1" ;
GRANT CREATE
MINING MODEL TO "&1" ;
...
-- SYSTEM PRIVILEGES
GRANT
SELECT ANY TABLE TO "&1";
GRANT
UPDATE ANY TABLE TO "&1";
GRANT
INSERT
ANY TABLE TO "&1" ;
