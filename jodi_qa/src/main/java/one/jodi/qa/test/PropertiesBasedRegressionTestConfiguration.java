...
public class PropertiesBasedRegressionTestConfiguration implements RegressionConfiguration {
   ...
   public PropertiesBasedRegressionTestConfiguration(final String propertiesFile, final String password,
      ...
      final Parameters params = new Parameters();//mock(Parameters.class);
      ...
      this.sysdbaPassword = new PasswordConfigImpl().getAdminDBPassword();
   ...
   public String getOracleTestDBPassword() {
      return new PasswordConfigImpl().getOracleTestDBPassword();
   }
}